...
const Criteria3Schema = new mongoose.Schema({
    ...
    criteria34: {
        ...
        file3_4_1: { type: String },
        incentives: { type: String },
        file3_4_2_1: { type: String },
        file3_4_2_2: { type: String },
        patents_published: { type: Number },
        file3_4_3_1: { type: String },
        file3_4_3_2: { type: String },
        phd_awarded: { type: Number },
        teachers_guides: { type: Number },
        file3_4_4_1: { type: String },
        file3_4_4_2: { type: String },
        research_papers_per_teacher: { type: Number },
        file3_4_5_1: { type: String },
        file3_4_5_2: { type: String },
        books_edited: { type: Number },
        file3_4_6_1: { type: String },
        file3_4_6_2: { type: String },
        e_content: { type: String },
        file3_4_7_1: { type: String },
        file3_4_7_2: { type: String },
        scopus348: { type: Number },
        web_of_science348: { type: Number },
        file3_4_8_1: { type: String },
        file3_4_8_2: { type: String },
        scopus349: { type: Number },
        web_of_science349: { type: Number },
        file3_4_9_1: { type: String },
        file3_4_9_2: { type: String },
    },
    criteria35: {
