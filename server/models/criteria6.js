...
const Criteria6Schema = new mongoose.Schema({
    ...
    criteria61: {
        text_6_1_1: { type: String },
        file6_1_1: { type: String },
        text_6_1_2: { type: String },
        file6_1_2: { type: String },
    },
    criteria62: {
        text_6_2_1: { type: String },
        file6_2_1: { type: String },
        text_6_2_2: { type: String },
        file6_2_2: { type: String },
        data_6_2_3: { type: String },
