...
// Replace the defaults below with your Telesign authentication credentials or pull them from environment variables.
const customerId = process.env.CUSTOMER_ID || "C01C41D8-79A2-4867-BE09-CEB84079B868";
const apiKey = process.env.API_KEY || "thepOgLONtrCG96BK5lXElzf/PuKEdjK+JTOWg0/sswZyy9WHt/NU1zizj+pnn4B6F1b2v+lvO4acqWOkR7mPA==";



// Set the default below to your test phone number or pull it from an environment variable. 
// In your production code, update the phone number dynamically for each transaction.
const phoneNumber = process.env.PHONE_NUMBER || "7276079913";
