...
app.use('/data',[Criteria1_submit,C11,C12,C13,C21,C22,C23,C24,C25,C26,fetchC1,fetchC2,C31,C32,C33,C35,C36,C37,Criteria3_submit,fetchC3,C51,C52,C53,C54,fetchC5,Criteria5_submit,Criteria2_submit]);
app.use('/files', Files);
