...
const CardC7 = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`http://localhost:5000/data/fetchC7?department=${department}&academicYear=${academicYear}`);
