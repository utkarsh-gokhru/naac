...
const Criteria62 = ({ onCrit62Data }) => {
    ...
    const fetchData = async () => {
        try {
            ...
            if (data) {
                settext6_2_1(data.text6_2_1 || '');
                settext6_2_2(data.text6_2_2 || '');
                setdata6_2_3(data.data6_2_3 || '');
                setFile6_2_1(data.file6_2_1 ? 'true' : 'false');
                setFile6_2_2(data.file6_2_2 ? 'true' : 'false');
                setFile6_2_3_1(data.file6_2_3_1 ? 'true' : 'false');
                setFile6_2_3_2(data.file6_2_3_2 ? 'true' : 'false');
            }
        } catch (error) {
            ...
            <div className="c-6-2-1">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                {file6_2_1 === 'true' && (<span style={{ color: 'green', fontWeight: 'bold' }}>&#10003;</span>)}
            ...
            <div className="c-6-2-2">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                {file6_2_2 === 'true' && (<span style={{ color: 'green', fontWeight: 'bold' }}>&#10003;</span>)}
                                Upload relevant supporting documents
                            </td>
                            <td></td>
                            <td>
            ...
            <div className="c-6-2-3">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                {file6_2_3_1 === 'true' && (<span style={{ color: 'green', fontWeight: 'bold' }}>&#10003;</span>)}
                        ...
                        <tr>
                            <td>
                                {file6_2_3_2 === 'true' && (<span style={{ color: 'green', fontWeight: 'bold' }}>&#10003;</span>)}
                                Upload relevant supporting documents
                            </td>
                            <td></td>
                            <td>
