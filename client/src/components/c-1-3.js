...
const Criteria13 = ({ onCrit13Data }) => {
  const [valueAddedCoursesCount1_3_2, setValueAddedCoursesCount1_3_2] =
    useState(null);
  const [enrolledStudentsCount1_3_3_1, setEnrolledStudentsCount1_3_3_1] =
    useState(null);
  ...
  const fetchData = async () => {
    try {
      ...
      if (data) {
        data.valueAddedCoursesCount1_3_2
          ? setValueAddedCoursesCount1_3_2(data.valueAddedCoursesCount1_3_2)
          : setValueAddedCoursesCount1_3_2("");
        data.enrolledStudentsCount1_3_3_1
          ? setEnrolledStudentsCount1_3_3_1(data.enrolledStudentsCount1_3_3_1)
          : setEnrolledStudentsCount1_3_3_1("");
        data.text_1_3_1 ? setText_1_3_1(data.text_1_3_1) : setText_1_3_1("");
        data.projectsCount1_3_4
          ? setProjectsCount1_3_4(data.projectsCount1_3_4)
          : setProjectsCount1_3_4("");
      }
    } catch (error) {
  ...
  const saveSection1_3_1 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save1-3-1",
        formdata
      );
  ...
  const saveSection1_3_2 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save1-3-2",
        formdata
      );
      console.log(response.data);
  ...
  const saveSection1_3_3 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save1-3-3",
        formdata
      );
      console.log(response.data);
  ...
  const saveSection1_3_4 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save1-3-4",
        formdata
      );
      console.log(response.data);
      ...
      <ul>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    xls, xlsx, doc, docx, pdf. <b>File size: 6MB</b>{" "}
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <li>
          <div className="c-1_3_2">
            <h4>
              1.3.2 - Number of value-added courses for imparting transferable
              and life skills offered during the year
            </h4>
            <input
              type="number"
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <button onClick={() => downloadExcel("1.3.2.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
                    <input
                      type="file"
                      id="fileUpload1_3_2_1"
                      onChange={(e) => setFile1_3_2_1(e.target.files[0])}
                      name="fileUpload"
                      accept=".xls, .xlsx"
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="file"
                      id="fileUpload1_3_2_2"
                      onChange={(e) => setFile1_3_2_2(e.target.files[0])}
                      name="fileUpload"
                      accept=".xls, .xlsx, .doc, .docx, .pdf"
                    />
                  </td>
        ...
        <li>
          <div className="c-1_3_3">
            <h4>
              1.3.3 - Total number of students enrolled in the courses under
              1.3.2 above
            </h4>
            <ul>
              <li>
                <div className="c-1_3_3_1">
                  <h4>
                    1.3.3.1 - Number of value-added courses for imparting
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEnrolledStudentsCount1_3_3_1(e.target.value)
                    }
                  />
                  <table>
                    <thead>
                    ...
                    <tbody>
                      <tr>
                        <td>Upload the data template</td>
                        <td>
                          <button onClick={() => downloadExcel("1.3.3.xlsx")}>
                            Data Template
                          </button>
                        </td>
                        <td>
                          <input
                            type="file"
                            id="fileUpload1_3_3_1_1"
                            onChange={(e) =>
                              setFile1_3_3_1_1(e.target.files[0])
                            }
                            name="fileUpload"
                            accept=".xls, .xlsx"
                          />
                      ...
                      <tr>
                        ...
                        <td>
                          <input
                            type="file"
                            id="fileUpload1_3_3_1_2"
                            onChange={(e) =>
                              setFile1_3_3_1_2(e.target.files[0])
                            }
                            name="fileUpload"
                            accept=".xls, .xlsx, .doc, .docx, .pdf"
                          />
        ...
        <li>
          <div className="c-1_3_4">
            <h4>
              1.3.4 - Number of students undertaking field projects/ research
              projects/ internships during the year
            </h4>
            <input
              type="number"
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>Upload the data template</td>
                  <td>
                    <button onClick={() => downloadExcel("1.3.4.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
                    <input
                      type="file"
                      id="fileUpload1_3_4_1"
                      onChange={(e) => setFile1_3_4_1(e.target.files[0])}
                      name="fileUpload"
                      accept=".xls, .xlsx"
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="file"
                      id="fileUpload1_3_4_2"
                      onChange={(e) => setFile1_3_4_2(e.target.files[0])}
                      name="fileUpload"
                      accept=".xls, .xlsx, .doc, .docx, .pdf"
                    />
                  </td>
