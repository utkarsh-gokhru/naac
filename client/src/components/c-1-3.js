...
const Criteria13 = ({ onCrit13Data }) => {
    ...
    const saveSection1_3_1 = async() => {
        ...
        try{
            const response = await axios.post("https://naacserver.onrender.com/save1-3-1", formdata);
    ...
    const saveSection1_3_2 = async() => {
        ...
        try{
            const response = await axios.post("https://naacserver.onrender.com/save1-3-2", formdata);
            console.log(response.data); 
    ...
    const saveSection1_3_3 = async() => {
        ...
        try{
            const response = await axios.post("https://naacserver.onrender.com/save1-3-3", formdata);
            console.log(response.data); 
    ...
    const saveSection1_3_4 = async() => {
        ...
        try{
            const response = await axios.post("https://naacserver.onrender.com/save1-3-4", formdata);
            console.log(response.data); 
