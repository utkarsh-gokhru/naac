...
const Criteria11 = ({ onCrit11Data }) => {
    ...
    const saveSection1_1_1 = async() => {
        ...
        try{
            const response = await axios.post("https://naacserver.onrender.com/save1-1-1", formdata);
    ...
    const saveSection1_1_2 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save1-1-2", formdata);
            console.log(response.data);
    ...
    const saveSection1_1_3 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save1-1-3", formdata);
            console.log(response.data);
