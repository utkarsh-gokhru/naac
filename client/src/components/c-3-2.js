...
const Criteria32 = ({onCrit32Data}) => {
    ...
    const saveSection3_2_1 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-2-1", formdata);
    ...
    const saveSection3_2_2 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-2-2", formdata);
            console.log(response.data);
    ...
    const saveSection3_2_3 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-2-3", formdata);
            console.log(response.data);
            alert("Saved Section 3.2.1 data successfully!");
        } catch (error) {
