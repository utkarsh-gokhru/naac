...
const Criteria32 = ({ onCrit32Data }) => {
  ...
  const saveSection3_2_1 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-2-1",
        formdata
      );
  ...
  const saveSection3_2_2 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-2-2",
        formdata
      );
      console.log(response.data);
  ...
  const saveSection3_2_3 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-2-3",
        formdata
      );
      console.log(response.data);
      alert("Saved Section 3.2.1 data successfully!");
      ...
      <ul>
        <li>
          <div className="c-3-2-1">
            <h4>
              3.2.1 - Extramural funding for Research (Grants sponsored by the
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <button onClick={() => downloadExcel("3.2.1.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
        ...
        <li>
          <div className="c-3_2_2">
            <h4>
              3.2.2- Grants for research projects sponsored by the government
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>Upload the data template</td>
                  <td>
                    <button onClick={() => downloadExcel("3.2.2.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>Upload the data template</td>
                  <td>
                    <button onClick={() => downloadExcel("3.2.3.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
