...
const Criteria65 = ({ onCrit65Data }) => {
    ...
    const saveSection6_5_1 = async () => {
        ...
        try {
            const response = await axios.post("http://localhost:5000/data/save6-5-1", formdata);
    ...
    const saveSection6_5_2 = async () => {
        ...
        try {
            const response = await axios.post("http://localhost:5000/data/save6-5-2", formdata);
            console.log(response.data);
    ...
    const saveSection6_5_3 = async () => {
        ...
        try {
            const response = await axios.post("http://localhost:5000/data/save6-5-3", formdata);
            console.log(response.data);
            alert("Saved Section 6.5.2 data successfully!");
        } catch (error) {
