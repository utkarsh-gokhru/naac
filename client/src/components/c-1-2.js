...
const Criteria12 = ({ onCrit12Data }) => {
  ...
  const saveSection1_2_1 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save1-2-1",
        formdata
      );
  ...
  const saveSection1_2_2 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save1-2-2",
        formdata
      );
      console.log(response.data);
  ...
  const fetchData = async () => {
    try {
      ...
      if (data) {
        data.programCount1_2_2
          ? setProgramCount1_2_2(data.programCount1_2_2)
          : setProgramCount1_2_2("");
        data.newCoursesCount1_2_1
          ? setNewCoursesCount1_2_1(data.newCoursesCount1_2_1)
          : setNewCoursesCount1_2_1("");
      ...
      <ul>
        <li>
          <div className="c-1_2_1">
            <h4>
              1.2.1 - Number of new courses introduced of the total number of
              courses across all programs offered during the year
            </h4>
            <input
              type="number"
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <button onClick={() => downloadExcel("1.2.1.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
        ...
        <li>
          <div className="c-1_2_2">
            <h4>
              1.2.2 - Number of Programmes in which Choice Based Credit System
              (CBCS)/elective course system has been implemented during the year
            </h4>
            <input
              type="number"
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <button onClick={() => downloadExcel("1.2.2.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
