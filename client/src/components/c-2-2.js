...
export const Criteria22 = ({ onCrit22Data }) => {
    ...
    const saveSection2_2_1 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save2-2-1", formdata);
    ...
    const saveSection2_2_2 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save2-2-2", formdata);
            console.log(response.data);
