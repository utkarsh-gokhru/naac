...
const Criteria61 = ({ onCrit61Data }) => {
    ...
    const saveSection6_1_1 = async () => {
        ...
        try {
            const response = await axios.post("http://localhost:5000/data/save6-1-1", formdata);
    ...
    const saveSection6_1_2 = async () => {
        ...
        try {
            const response = await axios.post("http://localhost:5000/data/save6-1-2", formdata);
            console.log(response.data);
