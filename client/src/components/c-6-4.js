...
const Criteria64 = ({ onCrit64Data }) => {
    ...
    const saveSection6_4_1 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save6-4-1", formdata);
    ...
    const saveSection6_4_2 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save6-4-2", formdata);
            console.log(response.data);
    ...
    const saveSection6_4_3 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save6-4-3", formdata);
            console.log(response.data);
            alert("Saved Section 6.4.2 data successfully!");
        } catch (error) {
    ...
    useEffect(() => {
        ...
        onCrit64Data(crit64);
    }, [text_6_4_1, file6_4_1, data_6_4_2, file6_4_2_1, file6_4_2_2, data_6_4_3, file6_4_3_1, file6_4_3_2, text_6_4_4, file6_4_4])
        ...
        <div className="c-6-4">
            ...
            <div className="c-6-4-1">
                ...
                <StyledTextArea
                    ...
                    value={text_6_4_1}
                    onChange={(e) => setText_6_4_1(e.target.value)}
                />
                <table>
                    <thead>
                        <tr>
            ...
            <div className="c-6-4-2">
                ...
                <input
                    ...
                    id="data_6_4_2"
                    value={data_6_4_2}
                    onChange={(e) => setData_6_4_2(e.target.value)}
                />
                <table>
                    <thead>
                        <tr>
            ...
            <div className="c-6-4-3">
                ...
                <input
                    ...
                    id="data_6_4_2"
                    value={data_6_4_3}
                    onChange={(e) => setData_6_4_3(e.target.value)}
                />
                <table>
                    <thead>
                        <tr>
            ...
            <div className="c-6-4-4">
                ...
                <StyledTextArea
                    ...
                    placeholder="Type the text here"
                    value={text_6_4_4}
                    onChange={(e) => setText_6_4_4(e.target.value)}
                />
                <table>
                    <thead>
                        <tr>
