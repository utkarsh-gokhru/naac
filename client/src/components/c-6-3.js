...
const Criteria63 = ({ onCrit63Data }) => {
    ...
    const fetchData = async () => {
        try {
            ...
            if (data) {
                settext6_3_1(data.text6_3_1 || '');
                setdata6_3_2(data.data6_3_2 || '');
                setdata6_3_3(data.data6_3_3 || '');
                setdata6_3_4(data.data6_3_4 || '');
                setFile6_3_1(data.file6_3_1 ? 'true' : 'false');
                setFile6_3_2_1(data.file6_3_2_1 ? 'true' : 'false');
                setFile6_3_2_2(data.file6_3_2_2 ? 'true' : 'false');
                setFile6_3_3_1(data.file6_3_3_1 ? 'true' : 'false');
                setFile6_3_3_2(data.file6_3_3_2 ? 'true' : 'false');
                setFile6_3_4_1(data.file6_3_4_1 ? 'true' : 'false');
                setFile6_3_4_2(data.file6_3_4_2 ? 'true' : 'false');
            }
        } catch (error) {
            ...
            <div className="c-6-3-1">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                {file6_3_1 === 'true' && (<span style={{ color: 'green', fontWeight: 'bold' }}>&#10003;</span>)}
            ...
            <div className="c-6-3-2">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                {file6_3_2_1 === 'true' && (<span style={{ color: 'green', fontWeight: 'bold' }}>&#10003;</span>)}
                        ...
                        <tr>
                            <td>
                                {file6_3_2_2 === 'true' && (<span style={{ color: 'green', fontWeight: 'bold' }}>&#10003;</span>)}
                                Upload relevant supporting documents
                            </td>
                            <td></td>
                            <td>
            ...
            <div className="c-6-3-3">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                {file6_3_3_1 === 'true' && (<span style={{ color: 'green', fontWeight: 'bold' }}>&#10003;</span>)}
                                Upload the data template
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                {file6_3_3_2 === 'true' && (<span style={{ color: 'green', fontWeight: 'bold' }}>&#10003;</span>)}
                                Upload relevant supporting documents
                            </td>
                            <td></td>
                            <td>
            ...
            <div className="c-6-3-4">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                {file6_3_4_1 === 'true' && (<span style={{ color: 'green', fontWeight: 'bold' }}>&#10003;</span>)}
                                Upload the data template
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                {file6_3_4_2 === 'true' && (<span style={{ color: 'green', fontWeight: 'bold' }}>&#10003;</span>)}
                                Upload relevant supporting documents
                            </td>
                            <td></td>
                            <td>
