...
const Criteria51 = ({ onCrit51Data }) => {
    ...
    const saveSection5_1_1 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save5-1-1", formdata);
    ...
    const saveSection5_1_2 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save5-1-2", formdata);
            console.log(response.data);
    ...
    const saveSection5_1_3 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save5-1-3", formdata);
            console.log(response.data);
    ...
    const saveSection5_1_4 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save5-1-4", formdata);
            console.log(response.data);
