...
const Criteria71 = ({ onCrit71Data }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`https://naacserver.onrender.com/data/7?department=${department}&academicYear=${academicYear}`);
        ...
        <div className="c-7-1">
            ...
            <div className="c-7-1-1">
                ...
                <StyledTextArea
                    ...
                    value={text7_1_1}
                    onChange={(e) => settext7_1_1(e.target.value)}
                />
                <table>
                    <thead>
                        <tr>
                ...
                <div>
                    <button onClick={() => saveSection({ text7_1_1, file7_1_1 }, '7-1-1')}>Save</button>
                </div>
            </div>
            ...
            <div className="c-7-1-3">
                ...
                <StyledTextArea
                    ...
                    placeholder="Type the text here"
                    value={text7_1_3}
                    onChange={(e) => settext7_1_3(e.target.value)}
                />
                <table>
                    <thead>
                        <tr>
                ...
                <div>
                    <button onClick={() => saveSection({ text7_1_3, file7_1_3 }, '7-1-3')}>Save</button>
                </div>
            </div>
            ...
            <div className="c-7-1-8">
                ...
                <StyledTextArea
                    ...
                    placeholder="Type the text here"
                    value={text7_1_8}
                    onChange={(e) => settext7_1_8(e.target.value)}
                />
                <table>
                    <thead>
                        <tr>
                ...
                <div>
                    <button onClick={() => saveSection({ text7_1_8, file7_1_8 }, '7-1-8')}>Save</button>
                </div>
            </div>
            ...
            <div className="c-7-1-9">
                ...
                <StyledTextArea
                    ...
                    placeholder="Type the text here"
                    value={text7_1_9}
                    onChange={(e) => settext7_1_9(e.target.value)}
                />
            </div>
            ...
            <div className="c-7-1-11">
                ...
                <StyledTextArea
                    ...
                    placeholder="Type the text here"
                    value={text7_1_11}
                    onChange={(e) => settext7_1_11(e.target.value)}
                />
                <table>
                    <thead>
                        <tr>
                ...
                <div>
                    <button onClick={() => saveSection({ text7_1_11, file7_1_11 }, '7-1-11')}>Save</button>
                </div>
            </div>
        </div>
    )
