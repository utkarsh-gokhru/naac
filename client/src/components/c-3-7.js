...
const Criteria37 = ({ onCrit37Data }) => {
  ...
  const saveSection3_7_1 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-7-1",
        formdata
      );
  ...
  const saveSection3_7_2 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-7-2",
        formdata
      );
      console.log(response.data);
      ...
      <ul>
        <li>
          <div className="c-3_7_1">
            <h4>
              ...
              instituions/research establishment/ industry for research and
              acadmec development of faculty and students during the year
            </h4>
            <ul>
              <li>
                <h4>
                  3.7.1.1 - Total number of collaborative activities with other
                  instituions/research establishment/ industry for research and
                  acadmec development of faculty and students during the year
                </h4>
                <input
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <button onClick={() => downloadExcel("3.7.1.xlsx")}>
                          Data Template
                        </button>
                      </td>
                      <td>
        ...
        <li>
          <div className="c-3_7_2">
            <h4>
              3.7.2- Number of functional MOUs with instituions/industries in
              India and abroad for internship, on-the job training, project
              work, student/faculty exchange and collaborative research during
              the year
            </h4>
            <input
              type="number"
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>Upload the data template</td>
                  <td>
                    <button onClick={() => downloadExcel("3.7.2.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
