...
const Criteria37 = ({onCrit37Data}) => {
    ...
    const saveSection3_7_1 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-7-1", formdata);
    ...
    const saveSection3_7_2 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-7-2", formdata);
            console.log(response.data);
