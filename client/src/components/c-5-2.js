...
const Criteria52 = ({ onCrit52Data }) => {
    ...
    const saveSection5_2_1 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save5-2-1", formdata);
    ...
    const saveSection5_2_2 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save5-2-2", formdata);
            console.log(response.data);
    ...
    const saveSection5_2_3 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save5-2-3", formdata);
            console.log(response.data);
