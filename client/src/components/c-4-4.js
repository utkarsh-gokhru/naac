...
const Criteria44 = ({ onCrit44Data }) => {
    ...
    const saveSection4_4_1 = async () => {
        ...
        try {
            const response = await axios.post("http://localhost:5000/data/save4-4-1", formdata);
    ...
    const saveSection4_4_2 = async () => {
        ...
        try {
            const response = await axios.post("http://localhost:5000/data/save4-4-2", formdata);
            console.log(response.data);
