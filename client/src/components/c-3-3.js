...
const Criteria33 = ({ onCrit33Data }) => {
    ...
    const saveSection3_3_1 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-3-1", formdata);
    ...
    const saveSection3_3_2 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-3-2", formdata);
            console.log(response.data);
    ...
    const saveSection3_3_3 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-3-3", formdata);
            console.log(response.data);
