...
const Criteria33 = ({ onCrit33Data }) => {
  ...
  const saveSection3_3_1 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-3-1",
        formdata
      );
  ...
  const saveSection3_3_2 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-3-2",
        formdata
      );
      console.log(response.data);
  ...
  const saveSection3_3_3 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-3-3",
        formdata
      );
      console.log(response.data);
      ...
      <ul>
        <li>
          <div className="c-3_3_1">
            <h4>
              3.3.1 - Institution has created an eco-system for innovation
              including incubation centre and other inititatives for creation
        ...
        <li>
          <div className="c-3_3_2">
            <h4>
              3.3.2 - Number of seminars/workshops conducted on Research
              Methodology, Intellectual Property Rights (IPR), Entrepreneurship
              and Skill Development during the year
            </h4>
            <input
              type="number"
              id="seminars"
            ...
            <ul>
              <li>
                <h4>
                  3.3.2.1 - Number of seminars/workshops conducted on Research
                  Methodology, Intellectual Property Rights (IPR),
                  Entrepreneurship and Skill Development year wise during the
                  year
                </h4>
                <input
                  type="number"
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <button onClick={() => downloadExcel("3.3.2.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
                    <input
                      type="file"
                      id="file3_3_2_1"
                      onChange={(e) => setFile3_3_2_1(e.target.files[0])}
                      name="fileUpload"
                      accept=".xls, .xlsx"
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="file"
                      id="file3_3_2_2"
                      onChange={(e) => setFile3_3_2_2(e.target.files[0])}
                      name="fileUpload2"
                      accept=".xls, .xlsx, .doc, .docx, .pdf"
                    />
                  </td>
        ...
        <li>
          <div className="c-3_3_3">
            <h4>
              3.3.3 - Number of awards/recogntions received for
              research/innovation by the institution/teachers/research
              scholars/students during the year
            </h4>
            <ul>
              <li>
                <h4>
                  3.3.3.1 - Number of awards/recogntions received for
                  research/innovation by the institution/teachers/research
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>Upload the data template</td>
                  <td>
                    <button onClick={() => downloadExcel("3.3.3.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
                    <input
                      type="file"
                      id="fileUpload3_3_3_1"
                      onChange={(e) => setFile3_3_3_1(e.target.files[0])}
                      name="fileUpload"
                      accept=".xls, .xlsx"
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="file"
                      id="fileUpload3_3_3_2"
                      onChange={(e) => setFile3_3_3_2(e.target.files[0])}
                      name="fileUpload2"
                      accept=".xls, .xlsx, .doc, .docx, .pdf"
                    />
                  </td>
