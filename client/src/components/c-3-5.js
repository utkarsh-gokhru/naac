...
const Criteria35 = ({onCrit35Data}) => {
    ...
    const saveSection3_5_1 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-5-1", formdata);
    ...
    const saveSection3_5_2 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-5-2", formdata);
            console.log(response.data);
