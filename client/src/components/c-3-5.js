...
const Criteria35 = ({ onCrit35Data }) => {
  ...
  const saveSection3_5_1 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-5-1",
        formdata
      );
  ...
  const saveSection3_5_2 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-5-2",
        formdata
      );
      console.log(response.data);
      ...
      <ul>
        <li>
          <div className="c-3_5_1">
            <h4>
              3.5.1 - Instution has a policy of consultancy including revenue
        ...
        <li>
          <div className="c-3_5_2">
            <h4>
              3.5.2- Revenue genrated from consultancy and corporate training
              during the year
            </h4>
            <ul>
              <li>
                <h4>
                  3.5.2.1- Total amount genrated from consultancy and corporate
                  training during the year (INR in Lakhs)
                </h4>
                <input
                  type="number"
                  id="consultancyRev"
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <button onClick={() => downloadExcel("3.5.2.xlsx")}>
                          Data Template
                        </button>
                      </td>
                      <td>
