    ...
    try {
      ...
      if (data) {
        ...
        if (data.criteria34) {
            ...
            count += data.criteria34.file3_4_1 ? 1 : 0;
            count += data.criteria34.incentives ? 1 : 0;
            count += data.criteria34.file3_4_2_1 ? 1 : 0;
            count += data.criteria34.file3_4_2_2 ? 1 : 0;
            count += data.criteria34.patents_published ? 1 : 0;
            count += data.criteria34.file3_4_3_1 ? 1 : 0;
            count += data.criteria34.file3_4_3_2 ? 1 : 0;
            count += data.criteria34.phd_awarded ? 1 : 0;
            count += data.criteria34.teachers_guides ? 1 : 0;
            count += data.criteria34.file3_4_4_1 ? 1 : 0;
            count += data.criteria34.file3_4_4_2 ? 1 : 0;
            count += data.criteria34.research_papers_per_teacher ? 1 : 0;
            count += data.criteria34.file3_4_5_1 ? 1 : 0;
            count += data.criteria34.file3_4_5_2 ? 1 : 0;
            count += data.criteria34.books_edited ? 1 : 0;
            count += data.criteria34.file3_4_6_1 ? 1 : 0;
            count += data.criteria34.file3_4_6_2 ? 1 : 0;
            count += data.criteria34.e_content ? 1 : 0;
            count += data.criteria34.file3_4_7_1 ? 1 : 0;
            count += data.criteria34.file3_4_7_2 ? 1 : 0;
            count += data.criteria34.scopus348 ? 1 : 0;
            count += data.criteria34.web_of_science348 ? 1 : 0;
            count += data.criteria34.file3_4_8_1 ? 1 : 0;
            count += data.criteria34.file3_4_8_2 ? 1 : 0;
            count += data.criteria34.scopus349 ? 1 : 0;
            count += data.criteria34.web_of_science349 ? 1 : 0;
            count += data.criteria34.file3_4_9_1 ? 1 : 0;
            count += data.criteria34.file3_4_9_2 ? 1 : 0;
        }
