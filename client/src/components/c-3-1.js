...
const Criteria31 = ({ onCrit31Data }) => {
  ...
  const saveSection3_1_1 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-1-1",
        formdata
      );
  ...
  const saveSection3_1_2 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-1-2",
        formdata
      );
      console.log(response.data);
  ...
  const saveSection3_1_3 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-1-3",
        formdata
      );
      console.log(response.data);
  ...
  const saveSection3_1_4 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-1-4",
        formdata
      );
      console.log(response.data);
  ...
  const saveSection3_1_5 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-1-5",
        formdata
      );
      console.log(response.data);
  ...
  const saveSection3_1_6 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-1-6",
        formdata
      );
      console.log(response.data);
      ...
      <ul>
        <li>
          <div className="c-3_1_1">
            <h4>
              3.1.1 - The institution Research facilities are frequently updated
              and there is well dedfined policy for promotion and research which
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <button onClick={() => downloadExcel("3.1.2.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
        ...
        <li>
          <div className="c-3_1_3">
            <h4>
              3.1.3 - Number of teachers receiving national/international
              fellowship/financial supported by various agencies for advanced
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>Upload the data template</td>
                  <td>
                    <button onClick={() => downloadExcel("3.1.3.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>Upload the data template</td>
                  <td>
                    <button onClick={() => downloadExcel("3.1.4.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
            ...
            <div className="c_3_1_5-feedback">
              ...
              <div className="radioBtn-feedback">
                <input
                  type="radio"
                  id="feed_3_1_5_any_4"
                  name="feed_3_1_5_group"
                  onChange={() =>
                    setFeed_3_1_5_Type("A. Any 4 or more of the above")
                  }
                />
                <label htmlFor="feed_3_1_5_any_4">
                ...
                <input
                  ...
                  name="feed_3_1_5_group"
                  onChange={() =>
                    setFeed_3_1_5_Type("B. Any 3 or more of the above")
                  }
                />
                <label htmlFor="feed_3_1_5_any_3">
                  B. Any 3 or more of the above
                </label>
                ...
                <input
                  ...
                  name="feed_3_1_5_group"
                  onChange={() =>
                    setFeed_3_1_5_Type("C. Any 2 or more of the above")
                  }
                />
                <label htmlFor="feed_3_1_5_any_2">
                  C. Any 2 or more of the above
                </label>
                ...
                <input
                  ...
                  name="feed_3_1_5_group"
                  onChange={() =>
                    setFeed_3_1_5_Type("D. Any 1 or more of the above")
                  }
                />
                <label htmlFor="feed_3_1_5_any_1">
                  D. Any 1 or more of the above
                </label>
                ...
                <input
                  ...
                  id="feed_3_1_5_none"
                  name="feed_3_1_5_group"
                  onChange={() => setFeed_3_1_5_Type("E. None of the above")}
                />
        ...
        <li>
          <div className="c-3-1-6">
            <h4>
              3.1.6 - Number of departments with UGC-SAP, CAS, DST-FIST, DBT,
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>Upload the data template</td>
                  <td>
                    <button onClick={() => downloadExcel("3.1.6.xlsx")}>
                      Data Template
                    </button>
                  </td>
                  <td>
