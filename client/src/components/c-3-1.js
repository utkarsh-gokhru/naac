...
const Criteria31 = ({ onCrit31Data }) => {
    ...
    const saveSection3_1_1 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-1-1", formdata);
    ...
    const saveSection3_1_2 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-1-2", formdata);
            console.log(response.data);
    ...
    const saveSection3_1_3 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-1-3", formdata);
            console.log(response.data);
    ...
    const saveSection3_1_4 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-1-4", formdata);
            console.log(response.data);
    ...
    const saveSection3_1_5 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-1-5", formdata);
            console.log(response.data);
    ...
    const saveSection3_1_6 = async () => {
        ...
        try {
            const response = await axios.post("https://naacserver.onrender.com/save3-1-6", formdata);
            console.log(response.data);
