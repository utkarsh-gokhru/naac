...
const Criteria36 = ({ onCrit36Data }) => {
  ...
  const saveSection3_6_1 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-6-1",
        formdata
      );
  ...
  const saveSection3_6_2 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-6-2",
        formdata
      );
      console.log(response.data);
  ...
  const saveSection3_6_3 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-6-3",
        formdata
      );
      console.log(response.data);
  ...
  const saveSection3_6_4 = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/data/save3-6-4",
        formdata
      );
      console.log(response.data);
      ...
      <ul>
        <li>
          <div className="c-3_6_1">
            <h4>
              3.6.1 - Extension activities in the neighbourhood community in
              terms of impact and sensitising students to social issues and
        ...
        <li>
          <div className="c-3_6_2">
            <h4>
              3.6.2- Number of awards received by the instituion,its teachers
              and students from Government/Government recognised bodies in
            ...
            <ul>
              <li>
                <h4>
                  ...
                  extension activities from Government/Government recognisd
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <button onClick={() => downloadExcel("3.6.2.xlsx")}>
                          Data Template
                        </button>
                      </td>
                      <td>
        ...
        <li>
          <h4>
            ...
            institution including those NSS/NCC/Red Cross/YRC during the year
            (including Government initiated programs such as Swachh Bharat, Aids
            Awareness, Gender issues, etc. and those organised in collaboration
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>Upload the data template</td>
                <td>
                  <button onClick={() => downloadExcel("3.6.3.xlsx")}>
                    Data Template
                  </button>
                </td>
                <td>
        ...
        <li>
          <h4>
            3.6.4 - Total number of students participating in extension
            activities listed at 3.6.3 above during the year
          </h4>
          <input
            type="number"
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>Upload the data template</td>
                <td>
                  <button onClick={() => downloadExcel("3.6.4.xlsx")}>
                    Data Template
                  </button>
                </td>
                <td>
