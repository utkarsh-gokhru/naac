  ...
  const handePopupOk = async () => {
    try {
      ...
      const response = await axios.post(
        "http://localhost:5000/data/criteria3/submit",
        formdata
      );
    ...
    <div className="criteria3">
      <div className="crit3-head">
        ...
        <div className="info-section">
          ...
          <ul>
            <li>
              When the save button is clicked, the progress will be restored
              when you come back.
            </li>
            <li>
              The data can be edited till the time you don't click the submit
              button
            </li>
            <li>
              Before clicking the submit button, ensure that all the fields are
              filled even if you had saved the progress
            </li>
          </ul>
        </div>
      </div>
