...
//   e.preventDefault();
//   try {
//     console.log("huuuuuuuuuraaaaa");
//     console.log("what is this fomdata: " + JSON.stringify(formData));
//     console.log("departemt name: " + formData.department);
//     const formDataWithFiles = new FormData();
//     formDataWithFiles.append("department", formData.department);
//     formDataWithFiles.append("academicYear", formData.academicYear);
//     console.log("the leng : " + formDataWithFiles.length());
//     console.log(
//       "some data of formdatawith files: " + JSON.stringify(formDataWithFiles)
//     );

//     for (const [key, value] of Object.entries(formData.questions)) {
//       if (typeof value === "object" && value.documents) {
//         if (Array.isArray(value.documents)) {
//           console.log("inside if: ");
//           for (const file of value.documents) {
//             console.log("inside for for loop : " + file);
//             formDataWithFiles.append(`${key}_document`, file);
//           }
//         }
//       } else if (value !== "") {
//         // If value is not an object and not empty, append it directly
//         formDataWithFiles.append(key, value);
//       }
//     }
//     console.log("jsut the formdata: " + JSON.stringify(formData));
//     console.log(
//       "hhhhhhhhhoooooooooppppppppppe: " + JSON.stringify(formDataWithFiles)
//     );
